...
def sign_up_s():
    ...
    if count==0:
        ...
        conn.commit()
        c.execute("INSERT INTO body VALUES(?, ?, ?, ?)", (username, 0, 0, 'GENDER'))
        conn.commit()
...
lbEdPassw=Label(frEdit, text='Password:',font=('Arial', 20,'bold'),
...
eEdName=Entry(frEdit, font=('Arial', 20), textvariable=EdName,relief=GROOVE, bd=5,fg='midnight blue').grid(row=2,column=1)
eEdEmail=Entry(frEdit, font=('Arial', 20), textvariable=EdEmail,relief=GROOVE, bd=5,fg='midnight blue').grid(row=3,column=1)
eEdNumber=Entry(frEdit, font=('Arial', 20), textvariable=EdNumber,relief=GROOVE, bd=5,fg='midnight blue').grid(row=4,column=1)
eEdHeight=Entry(frEdit, font=('Arial', 20), textvariable=EdHeight,relief=GROOVE, bd=5,fg='midnight blue').grid(row=5,column=1)
eEdWeight=Entry(frEdit, font=('Arial', 20), textvariable=EdWeight,relief=GROOVE, bd=5,fg='midnight blue').grid(row=6,column=1)
rdGenderM=Radiobutton(frEdit,fg='steel blue',activeforeground='midnight blue',variable=EdGender,
highlightcolor='midnight blue',borderwidth=10,font=('Arial', 20),
text='Male', value=1).grid(sticky=W,row=7, column=1)
rdGenderF=Radiobutton(frEdit,fg='steel blue',activeforeground='midnight blue',variable=EdGender,
highlightcolor='midnight blue',borderwidth=10,font=('Arial', 20),
text='Female', value=2).grid(sticky=E,row=7, column=1)
btEdS=Button(frEdit,font=('arial',15),text='SUBMIT',command=editing_s,
bd=5, fg='steel blue',justify=CENTER,activeforeground='blue',
relief=GROOVE).grid(row=8,column=0,sticky=W, padx=20)
btEdB=Button(frEdit,font=('arial',15),text='BACK',command=editing_c,
bd=5, fg='steel blue',justify=CENTER,activeforeground='blue',
relief=GROOVE).grid(row=8,column=1,sticky=E)
#--------------------schedule-------------------------------
...
Sgender=StringVar()
Sbmi=StringVar()
infoName=Label(frSched, text='Name:',font=('Arial', 20,'bold'), relief=RIDGE,
...
infoHeight=Label(frSched, text='Height:',font=('Arial', 20,'bold'), relief=RIDGE,
...
infoWeight=Label(frSched, text='Weight:',font=('Arial', 20,'bold'), relief=RIDGE,
...
infoGender=Label(frSched, text='Gender:',font=('Arial', 20,'bold'), relief=RIDGE,
...
infoBMI=Label(frSched, text='BMI:',font=('Arial', 20,'bold'), relief=RIDGE,
...
relief=GROOVE).grid(row=3,column=4,sticky=E)

##############table-info###############3
infoMorn=Label(frSched, text='Morning',font=('Arial', 20,'bold'), relief=RIDGE,
width=20, height=1,fg='Midnight blue',anchor='w').grid(row=4,column=2,sticky=W, pady=20)
infoEven=Label(frSched, text='Evening',font=('Arial', 20,'bold'), relief=RIDGE,
width=20, height=1,fg='Midnight blue',anchor='w').grid(row=4,column=4,sticky=W, pady=20)

infoDurationM=Label(frSched, text='Duration',font=('Arial', 20,'bold'),relief=RIDGE,
width=8, height=1,fg='blue',anchor='w').grid(row=5,column=1,sticky=W)
infoExM=Label(frSched, text='Exercise',font=('Arial', 20,'bold'),relief=RIDGE,
width=20, height=1,fg='blue',anchor='w').grid(row=5,column=2,sticky=W)

infoDurationE=Label(frSched, text='Duration',font=('Arial', 20,'bold'),relief=RIDGE,
width=8, height=1,fg='blue',anchor='w').grid(row=5,column=3,sticky=W)
infoExE=Label(frSched, text='Exercise',font=('Arial', 20,'bold'),relief=RIDGE,
...
#--------------------Main-window-aka-frame------------------
frMain=Frame(root, width=1000, height=500, bg='plum1')
